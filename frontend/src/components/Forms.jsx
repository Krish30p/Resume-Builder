...
export const AdditionalInfoForm = ({
  ...
  return (
    <div className={additionalInfoStyles.container}>
      ...
      {/* Languages Section */}
      <div className="mb-8">
        <h3 className={additionalInfoStyles.subheading}>Languages</h3>
        {languages?.map((lang, index) => (
          <div key={index} className={additionalInfoStyles.item}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-3">
                  Proficiency ({lang.progress ? Math.round(lang.progress / 20) : 0}/5)
                </label>
                <div className="mt-2">
                  <RatingInput
      ...
      {/* Interests Section */}
      <div>
        <h3 className={additionalInfoStyles.subheading}>Interests</h3>
